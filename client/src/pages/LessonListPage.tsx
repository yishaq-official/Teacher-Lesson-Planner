  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link
          to="/lessons/create"
          className="px-5 py-2.5 rounded-xl text-sm font-semibold text-white gradient-bg-primary hover:opacity-95 shadow-lg shadow-indigo-600/20 transition-all flex items-center justify-center gap-2 self-start sm:self-auto"
        >
      ...
      <div className="glass-panel rounded-2xl p-4 space-y-3 sm:space-y-0 sm:flex sm:items-center sm:gap-4 border border-slate-800">
        {/* Search */}
      ...
      {loading ? (
        ...
        <div className="glass-panel rounded-3xl p-12 text-center text-slate-400 space-y-4 max-w-lg mx-auto">
          ...
          <Link
            to="/lessons/create"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs shadow-lg shadow-indigo-600/20"
          >
            + Create Lesson Plan
          </Link>
        </div>
            ...
            >
              <div>
                ...
                <Link
                  ...
                  className="font-bold text-lg text-slate-100 group-hover:text-indigo-400 transition-colors line-clamp-1 mb-1"
                >
                  {lesson.title}
                </Link>
                ...
                {lesson.resources && lesson.resources.length > 0 && (
                  <div className="mb-4 p-2.5 rounded-xl bg-slate-900/60 border border-slate-800 text-xs text-indigo-300 flex items-center justify-between">
              ...
              <div>
                ...
                <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between text-xs">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <Link
                      to={`/lessons/${lesson._id}`}
                      className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs transition-colors ml-1"
                    >
                      View
                    </Link>
                  </div>
